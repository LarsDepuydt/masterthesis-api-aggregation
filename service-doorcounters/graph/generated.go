...
func (ec *executionContext) _TelemetryData_timestamp(ctx context.Context, field graphql.CollectedField, obj *model.TelemetryData) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_TelemetryData_timestamp(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_TelemetryData_timestamp(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
...
func (ec *executionContext) _TelemetryData(ctx context.Context, sel ast.SelectionSet, obj *model.TelemetryData) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "timestamp":
			out.Values[i] = ec._TelemetryData_timestamp(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "value":
...
func (ec *executionContext) marshalNTelemetryData2ᚕᚖgithubᚗcomᚋLarsDepuydtᚋmasterthesisᚑapiᚑaggregationᚋserviceᚑdoorcountersᚋgraphᚋmodelᚐTelemetryDataᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.TelemetryData) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTelemetryData2ᚖgithubᚗcomᚋLarsDepuydtᚋmasterthesisᚑapiᚑaggregationᚋserviceᚑdoorcountersᚋgraphᚋmodelᚐTelemetryData(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTelemetryData2ᚖgithubᚗcomᚋLarsDepuydtᚋmasterthesisᚑapiᚑaggregationᚋserviceᚑdoorcountersᚋgraphᚋmodelᚐTelemetryData(ctx context.Context, sel ast.SelectionSet, v *model.TelemetryData) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
